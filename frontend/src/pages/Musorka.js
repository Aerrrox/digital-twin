...
// Открыть модальное окно для создания участка
document.getElementById("create-plot-frame").addEventListener("click", () => {
    document.getElementById("create-plot-modal").style.display = "flex";
});

// Подтвердить создание участка
document.getElementById("create-plot-confirm").addEventListener("click", () => {
    const plotName = document.getElementById("plot-name-input").value.trim();
    ...
    document.getElementById("create-plot-modal").style.display = "none";
    document.getElementById("plot-name-input").value = ""; // Очистка поля
});

// Отмена создания участка
document.getElementById("create-plot-cancel").addEventListener("click", () => {
    document.getElementById("create-plot-modal").style.display = "none";
    document.getElementById("plot-name-input").value = ""; // Очистка поля
});
